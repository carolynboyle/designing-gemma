...
**Path:** experiments/07_capstone_readme/config.yaml
**Syntax:** yaml
**Generated:** 2026-05-15 14:53:19

```yaml
# =============================================================================
# experiments/07_capstone_readme/config.yaml
...
experiment:
  ...
  description: >
    ...
    from 06 as grounding. All three voices run against both models, producing
...
context:
  capstone_summary: "{{ capstone_summary }}"   # injected from 06 results at runtime
